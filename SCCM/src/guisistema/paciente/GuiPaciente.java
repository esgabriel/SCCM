...
public class GuiPaciente extends javax.swing.JFrame {
    ...
    DB db = new DB();
    ArrayList<Paciente> pacientes = db.leerTxt(db.PACIENTE);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        GuiAgregarPaciente ventanaAgregarPaciente = new GuiAgregarPaciente();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (!pacientes.isEmpty()) {
            GuiEliminarPaciente ventanaEliminarPaciente = new GuiEliminarPaciente();
            ventanaEliminarPaciente.setVisible(true);
            dispose();
        } else {
            JOptionPane.showMessageDialog(this, "No se encuentran pacientes registrados");
        }
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (!pacientes.isEmpty()) {
            GuiModificarPaciente ventanaModificarPaciente = new GuiModificarPaciente();
            ventanaModificarPaciente.setVisible(true);
            dispose();
        } else {
            JOptionPane.showMessageDialog(this, "No se encuentran pacientes registrados");
        }
